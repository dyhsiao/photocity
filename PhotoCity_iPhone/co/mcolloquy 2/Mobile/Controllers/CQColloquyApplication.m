...
- (BOOL) application:(UIApplication *) application didFinishLaunchingWithOptions:(NSDictionary *) launchOptions {
	...
	tabBarController.selectedIndex = 1;//[[NSUserDefaults standardUserDefaults] integerForKey:@"CQSelectedTabIndex"];
	...
	[tabBarController presentModalViewController:[CQChatController defaultController] animated:YES];
	...
	if (showWelcomeScreen || (![CQConnectionsController defaultController].connections.count && ![CQConnectionsController defaultController].bouncers.count)) {
		...
		connectionCreationViewController.url = nil;
		[tabBarController presentModalViewController:connectionCreationViewController animated:YES];
