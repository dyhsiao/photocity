...
- (void) _moveInputFieldForOrientation:(UIInterfaceOrientation) interfaceOrientation {
	...
	CGFloat shift = ([CQColloquyApplication sharedApplication].showingTabBar && !landscape ? keyboardBounds.size.height + 5 : keyboardBounds.size.height + 54); // Tab bar height
